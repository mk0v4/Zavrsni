...
public class FormaAnalizaCijene extends Forma<AnalizaCijene> {
    ...
    private void lstAnalizaCijenaValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstAnalizaCijenaValueChanged
        ...
        try {
            ...
            txtGrupaNorme.setText(lstAnalizaCijena.getSelectedValue().getGrupa_norme());
            txtOznakaNorme.setText(lstAnalizaCijena.getSelectedValue().getOznaka_norme());
            tarOpisNorme.setText(lstAnalizaCijena.getSelectedValue().getOpis());
            txtJedinicaMjere.setText(lstAnalizaCijena.getSelectedValue().getJedinica_mjere());
            txtUkupanNormativVremena.setText(lstAnalizaCijena.getSelectedValue().getUkupan_normativ_vremena().toString());
            txtUkupnoRad.setText(lstAnalizaCijena.getSelectedValue().getUkupna_cijena_rad().toString());
            txtKoeficijentFirme.setText(lstAnalizaCijena.getSelectedValue().getKoeficijent_firme().toString());
            txtUkupnoMaterijal.setText(lstAnalizaCijena.getSelectedValue().getUkupna_cijena_materijal().toString());
            txtUkupnaCijena.setText(lstAnalizaCijena.getSelectedValue().getSveukupan_iznos().toString());
            cmbStavkaTroskovnik.setSelectedItem(entitet.getStavka_troskovnik());
           
            DefaultListModel<AnalizaRad> m = new DefaultListModel<>();
            lstOperacije.setModel(m);
            entitet.getAnalize_radova().forEach((s) -> {
                m.addElement(s);
            });
            ucitajAnalizaRad();
    ...
    protected void spremi() {
        entitet.setGrupa_norme(txtGrupaNorme.getText());
        ...
        entitet.setStavka_troskovnik((StavkaTroskovnik) cmbStavkaTroskovnik.getSelectedItem());
        super.spremi();
        repaint();
    }
    ...
    private void ucitajAnalizaRad() {
        ...
        analizaRad.stream().forEach((p) -> {
            if (entitet != null) {
                boolean dodaj = true;
                for (AnalizaRad analizaR : entitet.getAnalize_radova()) {
