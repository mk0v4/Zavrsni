...
public class FormaStavkaTroskovnik extends Forma<StavkaTroskovnik>{
    ...
    private void lstStavkeTroskovnikaValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstStavkeTroskovnikaValueChanged
        ...
        try {
            ...
            txtOznakaStavke.setText(lstStavkeTroskovnika.getSelectedValue().getOznaka_stavka());
            tarOpisNorme.setText(entitet.getAnalize_cijena().toString());
            tarDodatanOpis.setText(lstStavkeTroskovnika.getSelectedValue().getDodatan_opis());
//            txtJedinicaMjere
            txtKolicina.setText(lstStavkeTroskovnika.getSelectedValue().getKolicina_troskovnik().toString());
            txtUkupnaCijena.setText(lstStavkeTroskovnika.getSelectedValue().getUkupna_cijena().toString());
      

            DefaultListModel<AnalizaCijene> m = new DefaultListModel<>();
            lstAnalizeCijena.setModel(m);
            entitet.getAnalize_cijena().forEach((s) -> {
                m.addElement(s);
            });
            ucitajAnalizaCijene();
    ...
    protected void spremi() {
        entitet.setOznaka_stavka(txtOznakaStavke.getText());
        entitet.setDodatan_opis(tarDodatanOpis.getText());
        entitet.setKolicina_troskovnik(new BigDecimal(txtKolicina.getText()));
        entitet.setUkupna_cijena(new BigDecimal(txtUkupnaCijena.getText()));
...
//        entitet.setSveukupan_iznos(new BigDecimal(txtUkupnaCijena.getText()));
    ...
    private void ucitajAnalizaCijene() {
        ...
        analizaCijene.stream().forEach((p) -> {
            if (entitet != null) {
                boolean dodaj = true;
                for (AnalizaCijene analizaC : entitet.getAnalize_cijena()) {
